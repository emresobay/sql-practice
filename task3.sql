--country tablosunda bulunan country sütunundaki ülke isimlerinden 'A' karakteri ile başlayıp 'a' karakteri
--ile sonlananları sıralayınız.
select country from country
where country like 'A%a';

--country tablosunda bulunan country sütunundaki ülke isimlerinden en az 6 karakterden oluşan ve sonu 'n' karakteri
--ile sonlananları sıralayınız.
select country from country 
